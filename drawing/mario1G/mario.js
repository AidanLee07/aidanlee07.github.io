...
function init() {
  ...
  ctx.fillRect(3 * unit, 2 * unit, 6 * unit, unit);
  ctx.fillRect(2 * unit, 3 * unit, 10 * unit, unit);
  ctx.fillRect(2 * unit, 9 * unit, 8 * unit, 1 * unit);
  ctx.fillRect(1 * unit, 10 * unit, 10 * unit, 1 * unit);
  ctx.fillRect(0 * unit, 12 * unit, 12 * unit, 1 * unit);
  ctx.fillRect(0 * unit, 11 * unit, 12 * unit, 1 * unit);
  ctx.fillStyle = "rgb(255,196,0)";
  ctx.fillRect(2 * unit, 4 * unit, 7 * unit, unit);
  ctx.fillRect(2 * unit, 5 * unit, 9 * unit, unit);
  ctx.fillRect(2 * unit, 6 * unit, 10 * unit, unit);
  ctx.fillRect(3 * unit, 7 * unit, 7 * unit, unit);
  ctx.fillRect(3 * unit, 8 * unit, 7 * unit, 1 * unit);
  ctx.fillRect(0 * unit, 12 * unit, 2 * unit, 1 * unit);
  ctx.fillRect(0 * unit, 13 * unit, 4 * unit, 1 * unit);
  ...
  ctx.fillStyle = "rgb(75,33,0)"
  ctx.fillRect(1 * unit, 16 * unit, 3 * unit, 1 * unit);
  ctx.fillRect(8 * unit, 16 * unit, 3 * unit, 1 * unit);
  ctx.fillRect(0 * unit, 17 * unit, 4 * unit, 1 * unit);
  ctx.fillRect(8 * unit, 17 * unit, 4 * unit, 1 * unit);
